...
import type { Candidato, CandidatoFormData } from '../../types/candidato';

interface EditarModalProps {
  isOpen: boolean;
  onClose: () => void;
  candidato: Candidato | null;
  onSubmit: (id: number, data: CandidatoFormData) => void;
}

interface EditarFormContentProps {
  candidato: Candidato;
  onClose: () => void;
  onSubmit: (id: number, data: CandidatoFormData) => void;
}

const EditarFormContent: React.FC<EditarFormContentProps> = ({
  candidato,
  onClose,
  onSubmit,
}) => {
  const [formData, setFormData] = useState<CandidatoFormData>({
    ...
    departamentoVaga: candidato.departamentoVaga,
  ...
  return (
    <form id="editar-form" onSubmit={handleSubmit} className="modal-form-grid">
...
export const EditarModal: React.FC<EditarModalProps> = ({
  isOpen,
  onClose,
  candidato,
  onSubmit,
